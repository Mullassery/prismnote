  ...
  return (
    <div className="fixed top-12 left-1/2 -translate-x-1/2 z-[60] w-[420px] pn-solid-bg border pn-bd rounded-xl shadow-2xl shadow-black/40 p-3">
      <div className="flex items-center justify-between mb-2">
        <span className="text-sm font-medium pn-text flex items-center gap-2"><Replace size={15} className="text-violet-400" /> Find &amp; Replace</span>
      ...
      <input autoFocus value={find} onChange={(e) => setFind(e.target.value)} placeholder="Find in all cells"
        className="w-full mb-2 px-2 py-1.5 rounded bg-white/5 border pn-bd pn-text text-[13px] outline-none focus:border-violet-500" />
